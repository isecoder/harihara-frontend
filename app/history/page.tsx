...
const historicalMessages: Record<LocaleType, string[]> = {
  ...
  kn: [
    "ಶ್ರೀ ಹರಿಹರೇಶ್ವರವು ಅನಾದಿ ಕಾಲದಿಂದಲೂ ಇದ್ದು ಋಷಿ ಶ್ರೇಷ್ಠರು ಈ ತೀರ್ಥಕ್ಷೇತ್ರದಲ್ಲಿ ತಪಸ್ಸನ್ನಾಚರಿಸಿ ಹರಿ ಮತ್ತು ಹರಿ ಇಬ್ಬರನ್ನು ಒಂದೇ ಮೂರ್ತಿಯಲ್ಲಿ ಸಂಕಲ್ಪಿಸಿ ಸ್ಥಾಪಿಸಿದ ಕ್ಷೇತ್ರವೇ ಶ್ರೀ ಹರಿಹರೇಶ್ವರ ದೇವಾಲಯ.",
