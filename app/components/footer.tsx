        ...
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="text-center lg:text-left mb-6 lg:mb-0">
            ...
            <ul className="space-y-1">
              <li>
                <Link href="/about" className="hover:underline hover:text-yellow-300 flex items-center">
              ...
              <li>
                <Link href="#" className="hover:underline hover:text-yellow-300 flex items-center">
                  <span className="inline-block w-4">
                    <span className="text-xs leading-4">►</span>
                  </span>
                  News
              ...
              <li>
                <Link href="/sevas" className="hover:underline hover:text-yellow-300 flex items-center">
                  <span className="inline-block w-4">
                    <span className="text-xs leading-4">►</span>
                  </span>
                  Seva List
              ...
              <li>
                <Link href="/gallery" className="hover:underline hover:text-yellow-300 flex items-center">
                  <span className="inline-block w-4">
                    <span className="text-xs leading-4">►</span>
                  </span>
                  Gallery
